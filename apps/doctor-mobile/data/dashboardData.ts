...
export const SAMPLE_APPOINTMENTS: Appointment[] = [
  ...
  },
  {
    ...
    contact: '0917-123-4567',
    email: 'mart.emman@email.com',
    notes: 'Quarterly check-up after whitening treatment.',
    imageUrl: require('../assets/images/researchers/mart.jpg'),
    status: 'scheduled',
  },
  {
    ...
    contact: '0918-234-5678',
    email: 'jendri.jacin@email.com',
    notes: 'Pre-aligner X-ray imaging for treatment planning.',
    imageUrl: require('../assets/images/researchers/jendri.jpg'),
    status: 'scheduled',
  },
  {
    ...
    contact: '0919-345-6789',
    email: 'kyler.per@email.com',
    notes: 'Post-treatment follow-up for root canal.',
    imageUrl: require('../assets/images/researchers/kyler.jpg'),
    status: 'scheduled',
  },
  {
    ...
    contact: '0916-111-2222',
    email: 'sarah.johnson@email.com',
    notes: 'Initial consultation for braces. Orthodontist evaluation needed.',
    imageUrl: require('../assets/images/user.png'),
    status: 'scheduled',
  },
  {
    ...
    contact: '0920-333-4444',
    email: 'michael.chen@email.com',
    notes: 'Follow-up check-up to monitor cavity treatment healing.',
    imageUrl: require('../assets/images/user.png'),
    status: 'scheduled',
  },
  {
    ...
    contact: '0917-123-4567',
    email: 'mart.emman@email.com',
    notes: 'Professional cleaning and plaque removal.',
    imageUrl: require('../assets/images/researchers/mart.jpg'),
    status: 'scheduled',
  },
  {
    ...
    contact: '0918-234-5678',
    email: 'jendri.jacin@email.com',
    notes: 'Aligner adjustment and progress review.',
    imageUrl: require('../assets/images/researchers/jendri.jpg'),
    status: 'scheduled',
  },
  {
    ...
    contact: '0916-111-2222',
    email: 'sarah.johnson@email.com',
    notes: 'Rescheduled cleaning appointment.',
    imageUrl: require('../assets/images/user.png'),
    status: 'cancelled',
  },
  {
    ...
    contact: '0920-333-4444',
    email: 'michael.chen@email.com',
    notes: 'Emergency root canal consultation for lower molar.',
    imageUrl: require('../assets/images/user.png'),
    status: 'scheduled',
  },
];
